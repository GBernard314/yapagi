...
class FeedActivity : BaseActivity() {
    ...
    private fun makeRequest() {
        ...
        commentList += Comment("1/1/2019", "FIRST !!!", "Billy Bob")
        commentList += Comment("1/1/2019", "erufvyeryufvbhe", "Billy Bob")

        list += Post("Isis_love ?", "1/1/1970", "Wouf", 99999, commentList, "https://instagram.fcdg2-1.fna.fbcdn.net/v/t51.2885-15/e35/51993659_572254839943780_6273454790177071551_n.jpg?_nc_ht=instagram.fcdg2-1.fna.fbcdn.net&_nc_cat=104&_nc_ohc=Jp3iQtqHAAwAX9pXCbm&tp=1&oh=7dfdd96c69a9985b86444b88eca3ea81&oe=604657E5")
        list += Post("PierroLeVeau", "1/1/1970", "GNGNGN j'ai eu une meilleure note que toi", 666, commentList, "https://instagram.fcdg2-1.fna.fbcdn.net/v/t51.2885-15/e35/71527670_785261731906367_7668804132584366294_n.jpg?_nc_ht=instagram.fcdg2-1.fna.fbcdn.net&_nc_cat=111&_nc_ohc=bDzoeRiw-7cAX8nplJo&tp=1&oh=9952ddcede9f0b6d6378cbfa20c19b9a&oe=6046FE0D")
        println("list = $list")
