...
class Database {
    companion object {
        ...
        private const val URL =
            "https://yapagi-8c1ba-default-rtdb.europe-west1.firebasedatabase.app/"
        ...
        fun saveUser(
            userId: String, userFirstName: String, userLastName: String,
                ...
                override fun onDataChange(dataSnapshot: DataSnapshot) {
                    ...
                    if (postsJson != null) {
                        for (post in postsJson) {
                            ...
                            val postModel: Post =
                                Gson().fromJson(Gson().toJson(post.value), Post::class.java)
                            if (postModel.comments.isNullOrEmpty()) {
                                postModel.comments = listOf<Comment>()
                            }
